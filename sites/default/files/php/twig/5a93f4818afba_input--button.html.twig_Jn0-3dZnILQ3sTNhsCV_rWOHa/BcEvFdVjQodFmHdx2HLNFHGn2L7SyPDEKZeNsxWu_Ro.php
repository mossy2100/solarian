...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/Users/shaun/Dropbox (Personal)/SITES/multiplanetary.game/htdocs/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
}
